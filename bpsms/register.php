        ...
        <form id="register-frm" action="" method="post">
          ...
          <div class="row">
            <div class="form-group col-md-6">
                <input type="text" name="firstname" id="firstname" pattern="[a-zA-Z]+" placeholder="Enter First Name" autofocus class="form-control form-control-sm form-control-border" required>
                <small class="ml-3">First Name</small>
            </div>
            <div class="form-group col-md-6">
                <input type="text" name="middlename" id="middlename" pattern="[a-zA-Z]+" placeholder="Enter Middle Name (optional)" class="form-control form-control-sm form-control-border">
                <small class="ml-3">Middle Name</small>
            </div>
            <div class="form-group col-md-6">
                <input type="text" name="lastname" id="lastname" pattern="[a-zA-Z]+" placeholder="Enter Last Name" class="form-control form-control-sm form-control-border" required>
          ...
          <div class="row">
            ...
            <div class="form-group col-md-6">
                <input type="text" name="contact" id="contact"  pattern="\d+" placeholder="Enter Contact #" class="form-control form-control-sm form-control-border" required>
          ...
          <div class="row">
            <div class="form-group col-md-12">
              ...
              <textarea name="address" id="address" rows="3" class="form-control form-control-sm rounded-0" placeholder="Gangabu, kathmandu, Nepal"></textarea>
            </div>
          </div>
          <hr>
          <div class="row">
            <div class="form-group col-md-6">
                <input type="email" name="email" id="email" placeholder="sd@gmail.com" pattern="[a-z0-9._%+\-]+@[a-z0-9.\-]+\.[a-z]{2,}$" class="form-control form-control-sm form-control-border" required>
